...
interface TokenModalProps {
  isOpen: boolean;
  onClose: () => void;
  tokenType: 'resume' | 'cover-letter' | 'interview';
...
export const TokenModal = ({ isOpen, onClose, tokenType, remainingTokens }: TokenModalProps) => {
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="text-center pb-6">
          ...
          <DialogTitle className="text-2xl font-bold text-warm-brown-800">
            Out of {tokenTypeLabels[tokenType]} Tokens
          </DialogTitle>
          <DialogDescription className="text-lg text-warm-brown-600 mt-2">
            You have <span className="font-semibold text-red-600">{remainingTokens} tokens</span> remaining for {tokenTypeLabels[tokenType].toLowerCase()}.
            <br />
                ...
                <CardContent className="space-y-4">
                  <div className="bg-warm-brown-100 p-3 rounded-lg border border-warm-brown-200">
                    ...
                    <div className="font-bold text-warm-brown-800 text-lg">
                      +{getTokenCount(option, tokenType)} {tokenTypeLabels[tokenType]} tokens
                    </div>
                  </div>
